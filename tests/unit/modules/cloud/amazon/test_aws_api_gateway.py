...
from ansible_collections.amazon.amazon.plugins.module_utils.ec2 import HAS_BOTO3
from ansible_collections.yum_unit_test_migration_spec.yum_collection.tests.unit.modules.utils import set_module_args

if not HAS_BOTO3:
    pytestmark = pytest.mark.skip("test_api_gateway.py requires the `boto3` and `botocore` modules")

import ansible_collections.yum_unit_test_migration_spec.yum_collection.plugins.modules.aws_api_gateway as agw
